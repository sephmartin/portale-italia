          ...
          {[
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium" style={{ color: "var(--color-text-muted)", fontFamily: "var(--font-body)" }}>{card.label}</span>
              </div>
              <p className="font-bold text-base" style={{ fontFamily: "var(--font-display)", color: card.urgent ? card.color : "var(--color-text)" }}>{card.value}</p>
              <p className="text-sm mt-0.5" style={{ color: "var(--color-text-faint)", fontFamily: "var(--font-body)" }}>{card.hint}</p>
            </Link>
          ))}
        </div>
      </div>
