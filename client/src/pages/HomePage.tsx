    ...
    <div className="space-y-8 fade-in">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: "var(--color-text-muted)", fontFamily: "var(--font-body)" }}>
            {new Date().toLocaleDateString("it-IT", { weekday: "long", day: "numeric", month: "long", year: "numeric" })} · SPID attivo · CIE attiva
          </p>
        </div>
        {unread > 0 && (
          <Link href="/dashboard"
            className="flex items-center gap-2 px-3 py-2 rounded-xl border text-sm font-semibold hover:shadow-md transition-all"
